...
// @Description only deletes the link on the Coder side, does not revoke the token on the provider side.
...
func (api *API) userExternalAuths(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, codersdk.UserExternalAuthResponse{
